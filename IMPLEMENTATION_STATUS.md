...
- リュミエールの世界座標と全身の描画基準を固定し、上半身・下半身が別々に上下して見えない待機へ調整
- `lumiere_hover_down.png` のフレームごとの余白差を正規化し、4フレームを0.3秒間隔の往復順で再生
- 髪・翼・服のなびきは残しつつ、4枚目から1枚目へ急に戻るぎこちなさを解消
...
- 全身の上下描画オフセットが常に0で、正規化済み浮遊フレームだけが変化すること
