...
const runtime=['game.js','game.css','fountain-polish.css','cloud-motion-fix.css','scene-layout.js','scene-effects.js','navigation.js','blocked-collision.js','controls.js','dialogue.js','dialogue.css','audio.js','audio.css','lumiere-outline.js'];
const files={};
