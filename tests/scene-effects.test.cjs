...
test('motion uses complete independent cycles; reduced motion retains gentle glow and slows water',()=>{
 for(const t of ['4.4s','3.1s','24s','4.7s','2.6s','40s','5s']) assert.ok(css.includes(t),t);
