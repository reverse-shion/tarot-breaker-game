...
const definitions=Object.freeze({
  ...
  "star-gate-camera":Object.freeze({id:"star-gate-camera",event:"star-gate-anomaly",segment:"star-gate-camera",map:"star_gate_garden",spawn:Object.freeze({landmark:"gate",offsetY:72}),requiredRuntime:Object.freeze(["star-gate-interaction.js","star-gate-camera-checkpoint.js"]),entryAction:"choose 星門を調べる",emittedSignal:"tarot-breaker:star-gate-camera-framed",receivingRuntime:"star-gate-camera-checkpoint.js",expectedFirstBehavior:"Camera pans upward and frames the full Star Gate",durableWritePolicy:"FORBIDDEN"})  ,
  "star-gate-full":Object.freeze({id:"star-gate-full",event:"star-gate-anomaly",segment:"star-gate-sequence",map:"star_gate_garden",spawn:Object.freeze({landmark:"gate",offsetY:72}),requiredRuntime:Object.freeze(["star-gate-interaction.js","star-gate-anomaly.js"]),entryAction:"choose 星門を調べる",emittedSignal:"tarot-breaker:star-gate-sequence-complete",receivingRuntime:"star-gate-anomaly.js",expectedFirstBehavior:"Choice -> camera -> sky background -> normal resonance -> reverse flow -> skyward release -> camera return",durableWritePolicy:"FORBIDDEN"})
});
